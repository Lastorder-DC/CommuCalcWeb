...
(적 체력이 0 이하면 적 쓰러짐)`}
            ...
            <p>적이 반격합니다. 적 공격력 + 적 다이스에서 캐릭터의 방어력과 방어구를 뺀 만큼 피해를 받습니다.</p>
            <pre className="bg-light p-2 rounded">
...
(캐릭터 체력이 0 이하면 0으로 고정)`}
            ...
            <div className="alert alert-info">
              <strong>예시:</strong> 적 공격력 5, 적 다이스 4, 캐릭터 방어력 5, 방어구 0<br />
